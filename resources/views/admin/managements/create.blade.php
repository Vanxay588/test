...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.managements.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('key') ? 'is-invalid' : '' }}" name="key_id" id="key_id" required>
                    @foreach($keys as $id => $entry)
                        <option value="{{ $id }}" {{ old('key_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('key'))
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sick') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sick" id="sick" value="1" {{ old('sick', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shabby') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shabby" id="shabby" value="1" {{ old('shabby', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('whip') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="whip" id="whip" value="1" {{ old('whip', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('smash') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="smash" id="smash" value="1" {{ old('smash', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hernia') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hernia" id="hernia" value="1" {{ old('hernia', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('lung') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="lung" id="lung" value="1" {{ old('lung', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('tag') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="tag" id="tag" value="1" {{ old('tag', 0) == 1 ? 'checked' : '' }}>
